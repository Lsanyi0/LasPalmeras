 ...
 */
@Entity
@Table(name = "historialprecioventa")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "Historialprecioventa.findAll", query = "SELECT h FROM Historialprecioventa h")
        ...
        , @NamedQuery(name = "Historialprecioventa.findByIdProducto", query = "SELECT h FROM Historialprecioventa h WHERE h.idProducto = :idProducto")})
